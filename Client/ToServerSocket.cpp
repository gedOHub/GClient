...
ToServerSocket::ToServerSocket(string ip, string port, fd_set* skaitomiSocket, fd_set* rasomiSocket, fd_set* klaidingiSocket):gNetSocket(ip, port, 0, skaitomiSocket, rasomiSocket, klaidingiSocket){
...
int ToServerSocket::Send(char* data, int lenght){
	int rSend = 0;
	while(rSend != lenght){
...
void ToServerSocket::Recive(SocketToObjectContainer^ container){
	using namespace std;
...
void ToServerSocket::CommandListAck( int rRecv ){
...
void ToServerSocket::CommandHello(){
	string buffer;
	header* head = (struct header* ) &this->commandBuffer[0];
	// Pildau antraste
	// Nustatua taga
...
void ToServerSocket::CommandConnect(SocketToObjectContainer^ container){
...
void ToServerSocket::CommandInitConnectAck(){
...
void ToServerSocket::CommandBeginRead(SocketToObjectContainer^ container){
...
void ToServerSocket::CommandClientConnectAck(SocketToObjectContainer^ container){
...
void ToServerSocket::CommandHelp(){
...
void ToServerSocket::CommandClear(){
